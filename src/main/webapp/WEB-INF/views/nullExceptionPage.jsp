...
<!-- <link rel="stylesheet" href="exceptionStyle.css"> -->
 <link href="<c:url value="/resources/css/exceptionStyle.css"/>"> 
<!-- <link rel="stylesheet" th:href="@{/resources/css/exceptionStyle.css}"> -->
<style>
@import
...
<body>
	<div id="error-page">
		<div class="content">
			...
			<h4 data-text="Opps! Page not found">Opps! Something went wrong
			</h4>
			<h3>${message }</h3><br>
			<p>Sorry, the page you're looking for doesn't exist. If you think
				something is broken, report a problem.</p>
			<div class="btns">
				<a href="">return home</a> <a href="">report problem</a>
			</div>
		</div>
	</div>
</body>
